...
class ContactForm extends React.Component {
  ...
  render() {
    const { sent, user_email, user_name, message, loading, errors } = this.state;
      ...
      <div className="my-3">
        ...
        <form onSubmit={this.sendEmail}>
          ...
          <div className="form-group text-left my-3">
            ...
            <textarea className={`form-control ${errors.message ? "is-invalid" : ""}`} id="textarea" rows="4" name="message" value={message} onChange={this.handleChange}></textarea>
